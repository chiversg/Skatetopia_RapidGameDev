...
public class CameraFollowHub : MonoBehaviour
{
    ...
    void SmoothFollow()
    {
        ...
        float targetPosX = Mathf.Clamp(target.position.x, -38.59417f, 2.179283f);
        followTarget.position = new Vector3(targetPosX, followTarget.position.y, target.position.z);
